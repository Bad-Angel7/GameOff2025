...
global.itemHover = instance_nearest(mouse_x, mouse_y, objItemParent)

if global.itemHover.isPurchased = false
{
...
layer_text_text(textIDName, global.itemHover.name)
...
layer_text_text(descriptionIDName, global.itemHover.description)
...
layer_text_text(priceIDName, global.itemHover.price)